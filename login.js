document.addEventListener('DOMContentLoaded', function () {
	...
	const validCredentials = [
		{ username: 'june8', password: 'summer123', validFrom: todayStart, validTo: june8End },
		{ username: 'month', password: 'month123', validFrom: todayStart, validTo: oneMonthLater },
		{ username: 'august', password: 'august2025', validFrom: new Date('2025-08-01 00:00:00'), validTo: new Date('2025-08-08 23:59:59') },
	];
	...
	loginForm.addEventListener('submit', function (e) {
		...
		if (user) {
			...
			// 检查是否有日期限制
			if ((user.validFrom && currentTimestamp < user.validFrom.getTime()) || (user.validTo && currentTimestamp > user.validTo.getTime())) {
